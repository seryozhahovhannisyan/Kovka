                                            ...
                                            <div class="wpb_text_column wpb_content_element ">
                                                <div class="wpb_wrapper">
                                                    <p><span style="color: #000000;"><img
                                                            class="size-full wp-image-316 alignleft"
                                                            src="http://zheldor-kovka.ru/wp-content/uploads/2016/12/guarantee07-1.png"
                                                            alt="" width="100" height="156">100% гарантия низкой цены на кованые изделия. В отличие от многих наших конкурентов, выставочных залов и других продавцов кованых изделий, мы с уверенностью можем сказать, что даём гарантию наших цен. Это означает, что в ценообразование входит стоимость металла, и покраска.</span>
                                                    </p>
                                                    <p><span style="color: #000000;">Отдельно оплачивается только доставка и монтаж изделий, о чем мы сразу предупреждаем клиентов. В некоторых случаях мы осуществляем доставку бесплатно. Мы гарантированно фиксируем утвержденные в договоре цены на кованые изделия и работу. С нами можно договориться!</span>
                                                    </p>
                                ...
                                <div class="wpb_column vc_column_container vc_col-sm-12">
                                    <div class="vc_column-inner ">
                                        <div class="wpb_wrapper">
                                            <div class="wpb_text_column wpb_content_element ">
                                                <div class="wpb_wrapper">
                                                    <p style="text-align: center;"><span style="color: #000000;">Стоимость остальных кованых деталей, элементов интерьера, элементов экстерьера, элементов декора, другая мебель и т.д. обсуждается индивидуально.</span>
                                                    </p>
                                                    <p style="text-align: center;"><span style="color: #000000;">Цены представленные в таблице не являются окончательными, с каждым клиентом обсуждаются индивидуальные <span
                                                            style="color: #ff0000;">СКИДКИ</span>,&nbsp;зависящие от объема работ!</span>
                                                    </p>
