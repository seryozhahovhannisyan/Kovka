...
<html >
<head>
    <link type="text/css" href="<%=request.getContextPath()%>/libs/widget/Mercedes-Benz_files/widget.min.css" rel="stylesheet">
...
<div class="cbh-wrapper cbh-ru" id="clbh_div">
    <div id="cbh_plank">
        <div class="cbh-plank-title">Оцените наш сайт</div>
        <ul class="cbh-stars" id="cbh_plank_rate">
            <li></li>
            <li></li>
            <li></li>
            <li></li>
        ...
        <div class="cbh-powered-by"><a href="http://callbackhunter.com/?utm_source=widget#a_aid=account"
                                       id="clbh_banner_work_to_link" target="_blank">Технология CallbackHunter.
            Подключите на 8 лет бесплатно.</a></div>
    </div>
    <div class="cbh-popup-wrapper" id="cbh_popup">
        <div class="cbh-body-wrapper">
            <div class="cbh-video-wrapper">
                <%--<iframe id="cbh_popup_video" frameborder="0" width="100%" height="377"
                        src="./Mercedes-Benz_files/saved_resource.html"></iframe>--%>
            </div>
            <div class="cbh-moving-arrow" id="cbh_moving_arrow"></div>
            <div class="cbh-window-controls">
                <div class="cbh-close-button cbh-controls">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="0 0 13.9 14.3" enable-background="new 0 0 13.9 14.3">
                        <polygon fill="#01A7E7"
                                 points="13.5,1.3 12.8,0.6 7,6.4 1.1,0.6 0.4,1.3 6.3,7.1 0.4,12.9 1.1,13.6 7,7.8 12.8,13.6 13.5,12.9 7.7,7.1 "></polygon>
                    </svg>
                </div>
                <div class="cbh-minimize-button cbh-controls">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                         viewBox="240 0 800 800" enable-background="new 240 0 800 800">
                        <rect x="307.1" y="654.5" fill="#01A7E7" width="671.3" height="55.9"></rect>
                    </svg>
                </div>
            </div>
            <div class="cbh-body" id="cbh_widget_body">
                <div class="cbh-media-content" id="brand">
                    <div class="cbh-brand-main"></div>
                    <div class="cbh-form-line cbh-fixed-bottom"></div>
                </div>
            </div>
            <div class="cbh-powered-by"><a href="http://callbackhunter.com/?utm_source=widget#a_aid=account"
                                           id="clbh_banner_work_to_link" target="_blank">Технология CallbackHunter.
    ...
    <div id="cbh-widget-cobrowsing">
        <div id="cbh-widget-cobrowsing__connect-dialog" class="cbh-widget-cobrowsing__connect-dialog cbh-hide">
            <div id="cbh-widget-cobrowsing__connect-form"><input type="text" id="cbh-widget-cobrowsing__code"
                                                                 class="cbh-widget-cobrowsing__code">
                <button type="button" id="cbh-widget-cobrowsing__connect" class="cbh-widget-cobrowsing__connect">
                    Подключиться
                </button>
            </div>
        </div>
        <div id="cbh-widget-cobrowsing__disconnect-dialog" class="cbh-widget-cobrowsing__disconnect-dialog cbh-hide">
            <button type="button" id="cbh-widget-cobrowsing__disconnect" class="cbh-widget-cobrowsing__connect">
                Отключиться
            </button>
        </div>
    </div>
    <div id="cbh_widget_wrapper" class="cbh-show">
        <div class="cbh-widget lightSpeedIn" id="clbh_phone_div" style="z-index: 9000000;">
            <div class="cbh-call-container" id="cbh_call_container" style="right: 126.4px; bottom: 0px;">
                <div class="cbh-widget-call cbh-widget-call_closed">
                    <div class="cbh-video-wrapper">
                        <%--<iframe class="cbh-slider-video" frameborder="0" width="100%" height="290"
                                src="./Mercedes-Benz_files/saved_resource(1).html"></iframe>--%>
                    </div>
                    <a href="http://mercedes-promo.ru/#" class="cbh-widget-call__close cbh-widget__close"><i
                    ...
                    <div class="cbh-widget-call__container">
                        <div class="cbh-widget-call__container-inner" id="cbh_widget_call_container">
                            <div class="cbh-widget-call__hello" id="cbh_slider_header">
                                <div class="sheff sheff--w1a">В офисе ни души, мы позвоним <a
                                        href="http://mercedes-promo.ru/#" class="cbh-dialog-action-link"
                                        id="cbh_dialog_day">сегодня</a></div>
                            </div>
                                ...
                                <div class="cbh-widget-call__container-select">
                                    ...
                                    <div class="cbh-widget-call__btn-area cbh-widget-call__timer">
                                        <button type="button" class="cbh-widget-call__btn" id="cbh_slider_call_btn">
                                            <div class="sheff sheff--w1b">Жду звонка!</div>
                                        </button>
                    ...
                    <div class="cbh-widget-call__lbl"><a
                            href="http://callbackhunter.com/?utm_source=widget#a_aid=account"
                            id="clbh_banner_work_to_link" target="_blank">Технология CallbackHunter. Подключите на 8 лет
                        бесплатно.</a><span id="cbh-wdiget-cobrowsing-code"></span></div>
                </div>
                        ...
                        <button type="button" class="cbh-widget-button">
                            <div class="cbh-video-wrapper">
                                <%--<iframe class="cbh-slider-video" frameborder="0" width="515" height="290"--%>
                                        <%--src="./Mercedes-Benz_files/saved_resource(2).html"></iframe>--%>
                            </div>
                            <i class="cbh-widget-button-phone cbh-rotate-icon"></i><i class="cbh-widget-button-call">Call
                            back</i><i class="cbh-widget-button-logo"></i></button>
                    </div>
                </div>
            </div>
            <div class="cbh-chat-container" id="cbh_chat_container" style="right: 126.4px; bottom: 70px;">
                <div class="cbh-widget-chat cbh-widget-chat_closed"><a href="http://mercedes-promo.ru/#"
                                                                       class="cbh-widget-chat__close cbh-widget__close"><i
                        class="cbh-widget-icon-cancel"></i></a>
                ...
                <div class="cbh-widget-msg-wr cbh-widget-wr cbh-hide">
                    <div class="cbh-widget-msg"><span class="cbh-widget-alert cbh-hide"><div class="cbh-button-balloon"><div
                            class="cbh-button-balloon-box">Непрочитанные сообщения</div></div><span
                            class="cbh-button-balloon-num"></span></span>
                        <button type="button"
                                class="cbh-widget-button cbh-widget-msg__button cbh-widget-button-text-enabled"><i
                                class="cbh-widget-button-msg cbh-rotate-icon"></i><i
                                class="cbh-widget-button-chat">Chat</i><i class="cbh-widget-button-logo"></i></button>
                    </div>
                </div>
            </div>
        </div>
