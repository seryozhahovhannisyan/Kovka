        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form id="aboutForm" action="admin-about-edit.htm" method="post" data-parsley-validate=""
                        ...
                        <div class="form-group">
                            ...
                            <div id="email" class="col-md-6 col-sm-6 col-xs-12">
                                <s:iterator var="email" value="about.emails">
                                    <input name="emailValues" value='<s:property value="#email"/>' required="required"
                        ...
                        <div class="form-group">
                            ...
                            <div id="phone" class="col-md-6 col-sm-6 col-xs-12">
                                <s:iterator var="phone" value="about.phones">
                                    <input name="phoneValues" value='<s:property value="#phone"/>' required="required"
                                           class="form-control col-md-7 col-xs-12" type="text"/>
                                </s:iterator>
                            </div>
                        ...
                        <s:iterator var="info" value="about.infos" status="st">
                            ...
                            <div class="form-group">
                                ...
                                <div id="address<s:property value="#info.language.key"/>"
                                     class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="infosForEdit[<s:property value="#st.index"/>].address"
                                           value='<s:property value="#info.address"/>'
                                           class="form-control col-md-7 col-xs-12" type="text"/>
                            ...
                            <div class="form-group">
                                ...
                                <div id="description<s:property value="#info.language.key"/>"
                                     class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="infosForEdit[<s:property value="#st.index"/>].description"
                                           value='<s:property value="#info.description"/>'
                                           class="form-control col-md-7 col-xs-12" type="text"/>
                                </div>
