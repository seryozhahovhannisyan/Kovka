...
$(function() {
    var uploader = $("#uploader").plupload({
        ...
        url: "/upload-product.htm?sketchId=<s:property value='sketchId'/> ",
                                ...
                                <div class="col-md-55">
                                    <div class="thumbnail">
                                        <div class="image view view-first">
                                            <img style="width: 100%; display: block;"  src="<s:property value='%{getProductImage(#product.image.fileName)}'/>" alt="image">
                                            <div class="mask">
                                                <p>Your Text</p>
