...
<script src="<%=request.getContextPath()%>/js/cashier/object-list.js"></script>
                        ...
                        <div class="row">
                            ...
                            <div ng-controller="listController" id="listContent">
                                ...
                                <s:if test="%{dataCount != 0}">
                                    ...
                                    <input type="hidden" ng-model="actionVerifyPath" ng-init="actionVerifyPath='branch-verify.htm'"/>
