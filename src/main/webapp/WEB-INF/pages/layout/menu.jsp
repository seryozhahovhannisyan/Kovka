        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section active">
                ...
                <ul style="" class="nav side-menu">
                    ...
                    <s:if test="%{#session.cashier.privilege.id == @com.kovka.common.data.merchant.lcp.Privilege@ALL.getId() ||
                                    #session.cashier.privilege.id == @com.kovka.common.data.merchant.lcp.Privilege@CRUD_COMPANY.getId()  }">
                    ...
                    <%--CRUD_BRANCH menu--%>
                    <s:elseif test="%{#session.cashier.privilege.id == @com.kovka.common.data.merchant.lcp.Privilege@CRUD_BRANCH.getId() }">
                        <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <li><a href="cashiers.htm">Cashiers</a></li>
                            </ul>
                    ...
                    <%--CRUD_CASHIER menu--%>
                    <s:elseif test="%{#session.cashier.privilege.id == @com.kovka.common.data.merchant.lcp.Privilege@CRUD_CASHIER.getId()}">
                        <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <li><a href="cashiers.htm">Cashiers</a></li>
                            </ul>
                    ...
                    <%--CRUD_CASHIER menu--%>
                    <s:elseif test="%{#session.cashier.privilege.id == @com.kovka.common.data.merchant.lcp.Privilege@CASHIER.getId()}">
                        <li>
                            <a><i class="fa fa-money"></i> Provider <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <li><a href="provide.htm">Provided by Connectto</a></li>
