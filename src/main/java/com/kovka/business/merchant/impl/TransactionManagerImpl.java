...
import com.kovka.common.data.transaction.deposit.*;
import com.kovka.common.data.transaction.lcp.TransactionState;
import com.kovka.common.data.transaction.withdraw.*;
...
public class TransactionManagerImpl implements ITransactionManager {
    ...
    private JSONObject prepareJSONObject(TransactionWithdraw data, boolean encrypt) {
...
//        jsonObject.put("rationalDuration",  encrypt ? WalletEncription.encrypt(rationalDuration) : rationalDuration);
    ...
    private JSONObject prepareJSONObject(TransactionDeposit data, boolean encrypt)  {
